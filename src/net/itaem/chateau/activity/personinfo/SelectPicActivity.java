...
public class SelectPicActivity extends Activity implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.view_activity_select_pic);
		initView();
	} 
	...
	private void pickPhoto() {
		System.out.println("开始调用系统的 选择图片"); 
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		{
			System.out.println("调用系统选择图片【返回】");
...
//		}
	...
	private void doPhoto(int requestCode,Intent data)
	{
		...
		{
			System.out.println("选择图片成功："+picPath);
//			lastIntent.putExtra(KEY_PHOTO_PATH, picPath);
//			setResult(Activity.RESULT_OK, lastIntent);
			ClipImageLayout.picPath=picPath;
			startActivity(new Intent(this, PersonalImageClipActivity.class));
			finish();
		}else{
